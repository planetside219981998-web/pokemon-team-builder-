...
export function Navigation() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-50 bg-slate-800/95 backdrop-blur border-t border-slate-700 md:static md:border-t-0 md:border-b md:border-slate-700">
      <div className="max-w-5xl mx-auto flex justify-around md:justify-start md:gap-4 md:px-4">
        ...
        <NavLink to="/iv" className={linkClass}>
          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 7h6m0 10v-3m-3 3h.01M9 17h.01M9 14h.01M12 14h.01M15 11h.01M12 11h.01M9 11h.01M7 21h10a2 2 0 002-2V5a2 2 0 00-2-2H7a2 2 0 00-2 2v14a2 2 0 002 2z" />
          </svg>
          <span>{t('nav.ivCalc')}</span>
        </NavLink>
        <NavLink to="/h2h" className={linkClass}>
          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
